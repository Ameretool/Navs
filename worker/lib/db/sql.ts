...
export const CATEGORY_LIST_SQL =
  'SELECT id, parent_id, title, icon, sort, created_at FROM categories ORDER BY parent_id IS NOT NULL, parent_id ASC, sort ASC, id ASC'
...
export const PUBLIC_CATEGORY_LIST_SQL =
  'SELECT id, parent_id, title, icon, sort FROM categories ORDER BY parent_id IS NOT NULL, parent_id ASC, sort ASC, id ASC'
